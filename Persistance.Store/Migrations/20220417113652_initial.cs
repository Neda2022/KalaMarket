    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1L, new DateTime(2022, 4, 17, 16, 6, 51, 832, DateTimeKind.Local).AddTicks(6347), false, "Admin", null, null });

            migrationBuilder.InsertData(
                table: "Roles",
                columns: new[] { "Id", "InsertTime", "IsRemoved", "Name", "RemoveTime", "UpdateTime" },
                values: new object[] { 2L, new DateTime(2022, 4, 17, 16, 6, 51, 840, DateTimeKind.Local).AddTicks(6878), false, "Operator", null, null });

            migrationBuilder.InsertData(
                table: "Roles",
                columns: new[] { "Id", "InsertTime", "IsRemoved", "Name", "RemoveTime", "UpdateTime" },
                values: new object[] { 3L, new DateTime(2022, 4, 17, 16, 6, 51, 840, DateTimeKind.Local).AddTicks(7228), false, "Customer", null, null });
